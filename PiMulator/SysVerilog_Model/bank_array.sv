...
module bank_array #(
    ...
    input logic rd_o_wr, 
    input logic rowclone_en,             // Trigger the copy
    ...
    input logic [16:0] virt_src_row, // The untranslated 17-bit address
    ...
    input logic [1:0] ambit_en,             // Trigger the Ambit operation
    ...
    always @ (posedge clk) begin
        if (ambit_en == 2'd1) begin
            ...
            // Bulk copy the entire row in simulation.
            for (int c = 0; c < (1<<COLWIDTH); c++) begin
